...
def parse_cli_args():
    ...
    parser.add_argument("--nums", help="start no of trains to check", type=int, metavar="1", default=1)
    parser.add_argument("--num", help="end no of trains to check", type=int, metavar="2", default=2)
